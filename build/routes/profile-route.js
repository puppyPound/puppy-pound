...
profileRouter.put('/profiles/:id', jsonParser, function (request, response, next) {
  ...
  return _profile2.default.findByIdAndUpdate(request.params.id, request.body, options).then(function (updatedProfile) {
    _logger2.default.log(_logger2.default.INFO, 'PROFILE - ROUTE: responding with a 200 status code');
